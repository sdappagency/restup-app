...
@Component({
  selector: 'app-ui-menu-online',
  templateUrl: './ui-menu-online.component.html',
  styleUrls: ['./ui-menu-online.component.scss']
})
export class UiMenuOnlineComponent implements OnInit {
  products: any[] = [];
  selectedProduct: any;
  quantity: number = 1;
  ...
  getStarters() {
    this.subscription = this.productService.getStarters().pipe(
      catchError(error => {
