...
@Component({
  selector: 'app-ui-kitchen-room',
  templateUrl: './ui-kitchen-room.component.html',
  styleUrls: ['./ui-kitchen-room.component.scss']
})
export class UiKitchenRoomComponent implements OnInit {
  orders: any[] = [];
  selectedProduct: any;
