...
@Component({
  selector: 'app-ui-kitchen-pickup',
  templateUrl: './ui-kitchen-pickup.component.html',
  styleUrls: ['./ui-kitchen-pickup.component.scss']
})
export class UiKitchenPickupComponent implements OnInit {
  orders: any[] = [];
  selectedProduct: any;
